...
########################################
paths = ['/mnt/d/BaiduNetdiskDownload/32.31.250.103/20240501_20240501125647_20240501140806_125649.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.103/20240501_20240501140806_20240501152004_140807.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.105/20240501_20240501115227_20240501130415_115227.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.105/20240501_20240501130415_20240501141554_130415.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.105/20240501_20240501141554_20240501152820_141555.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.107/20240501_20240501114103_20240501135755_114103.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.107/20240501_20240501135755_20240501161432_135755.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.108/20240501_20240501113543_20240501135236_113542.mp4',
        '/mnt/d/BaiduNetdiskDownload/32.31.250.108/20240501_20240501135236_20240501160912_135235.mp4']

source_dir = '/mnt/d/BaiduNetdiskDownload/2.2024年中国研究生数学建模竞赛E题数据/2024年中国研究生数学建模竞赛E题数据/2024年中国研究生数学建模竞赛E题数据/高速公路交通流数据/32.31.250.103/20240501_20240501140806_20240501152004_140807.mp4' # '0'    # 要打开的文件。若要调用摄像头，需要设置为字符串'0'，而不是数字0，按q退出播放
source_dir = '../yolo_tracking/output.mp4'
source_dir = paths[1]
output_dir = 'inference/32.31.250.103/2' # 要保存到的文件夹
...
class_list = [2,5,6,7]    # 类别序号，在coco_classes.txt中查看（注意是序号不是行号），可以有一个或多个类别
point_idx = 3       # 方框的检测点位置(0, 1, 2, 3, 4)，看下边的图，当一个方框的检测点跨过检测线时，统计数会+1

lines = [           # 在这里定义检测线
    # 一条线就是一个list，内容为[x1, y1, x2, y2, (R, G, B), 线的粗细]，例如：
    [260,165,786, 210, (255,0,0), 2], # path[0,1]划线
